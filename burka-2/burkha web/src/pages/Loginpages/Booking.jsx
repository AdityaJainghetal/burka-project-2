  ...
  return (
    <Container className="py-16 max-w-7xl mx-auto bg-gray-50 min-h-screen">
      <div className="flex justify-between items-center mb-8">
        <h3 className="text-3xl font-bold text-gray-800 tracking-tight">Your Payment History</h3>
        <Button
          variant="success"
            ...
            <Table className="table align-middle">
              <thead className="bg-gray-100">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-sm font-semibold text-gray-700">Payment Mode</th>
                  <th className="px-6 py-3 text-left text-sm font-semibold text-gray-700">Status</th>
                  <th className="px-6 py-3 text-left text-sm font-semibold text-gray-700">Remark</th>
