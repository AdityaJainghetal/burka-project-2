...
//     navigate(`/product-details-two/${courseId}`);
//   };
...
//             <div className={`list-grid-wrapper ${grid && "list-view"}`}>
//               {courses.map((course) => (
//                 <div key={course.id} className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
//                   <Link
//                     to="/product-details-two"
//                     // onClick={handleCourseClick(courseId)}
//                     className="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative"
...
//                   <li className="mb-24">
//                     <div 
//                       className={`text-gray-900 hover-text-main-600 cursor-pointer ${activeCategory === 'All' ? 'text-main-600' : ''}`}
...
//                       <div 
//                         className={`text-gray-900 hover-text-main-600 cursor-pointer ${activeCategory === category.name ? 'text-main-600' : ''}`}
//                         onClick={() => setActiveCategory(category.name)}
//                       >
//                         {category.name} ({courses.filter(course => course.category?.name === category.name).length})
//                       </div>
//                     </li>
//                   ))}
//                 </ul>
...
//             {/* Top Start */}
//             <div className="flex-between gap-16 flex-wrap mb-40 ">
//               <span className="text-gray-900">Showing 1-{filteredCourses.length} of {filteredCourses.length} result</span>
//               <div className="position-relative flex-align gap-16 flex-wrap">
//                 <div className="list-grid-btns flex-align gap-16">
//                   <button 
//                     type="button"
...
// import { addtoCart } from '../../src/Redux/CardSlice'; // Update path as needed
          ...
          <div className="col-lg-9">
            ...
            <div className="flex-between gap-16 flex-wrap mb-40 ">
              <span className="text-gray-900">
                Showing 1-{filteredCourses.length} of {filteredCourses.length} result
              </span>
              <div className="position-relative flex-align gap-16 flex-wrap">
                <div className="list-grid-btns flex-align gap-16">
                  <button
